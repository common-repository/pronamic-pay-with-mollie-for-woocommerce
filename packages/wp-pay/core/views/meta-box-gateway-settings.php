...
$sections = [
	'general'         => (object) [
		'title'  => __( 'General', 'pronamic-pay-with-mollie-for-woocommerce' ),
		'fields' => [],
	],
	'advanced'        => (object) [
		'title'  => __( 'Advanced', 'pronamic-pay-with-mollie-for-woocommerce' ),
		'fields' => [],
	],
	'feedback'        => (object) [
		'title'  => __( 'Feedback', 'pronamic-pay-with-mollie-for-woocommerce' ),
		'fields' => [],
	],
	'payment_methods' => (object) [
		'title'  => __( 'Payment Methods', 'pronamic-pay-with-mollie-for-woocommerce' ),
		'fields' => [
			[
				'section'  => 'payment_methods',
				'title'    => __( 'Supported Payment Methods', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'type'     => 'custom',
...
if ( $integration->supports( 'webhook' ) ) {
	$fields[] = [
		'section'  => 'feedback',
		'title'    => __( 'Webhook Status', 'pronamic-pay-with-mollie-for-woocommerce' ),
		'type'     => 'custom',
...
if ( $integration->supports( 'webhook' ) && ! $integration->supports( 'webhook_no_config' ) ) {
	...
	if ( $webhook_config_needed ) {
		...
		$fields[] = [
			'section'  => 'general',
			'title'    => __( 'Transaction feedback', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'type'     => 'custom',
			'callback' => function () {
				printf(
					'⚠️ %s',
