...
if ( empty( $subscriptions ) ) : ?>
	...
	<p>
		<?php esc_html_e( 'This payment is not related to a subscription.', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
	</p>
...
<?php else : ?>
	...
	<?php foreach ( $subscriptions as $subscription ) : ?>
		...
		<table class="form-table">
			...
			<tr>
				<th scope="row">
					<?php echo esc_html_x( 'Recurrence', 'Recurring payment', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</th>
				<td>
					<?php
