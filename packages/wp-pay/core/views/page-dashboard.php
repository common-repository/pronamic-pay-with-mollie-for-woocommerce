			...
			<?php if ( current_user_can( 'edit_payments' ) ) : ?>
				...
				<div id="postbox-container-<?php echo \esc_attr( (string) $container_index ); ?>" class="postbox-container">
					<div id="normal-sortables" class="meta-box-sortables ui-sortable">
						...
						<div class="postbox">
							<div class="postbox-header">
								<h2 class="hndle"><span><?php esc_html_e( 'Pronamic Pay Status', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></span></h2>
							</div>
					...
					<div id="normal-sortables" class="meta-box-sortables ui-sortable">
						...
						<div class="postbox">
							<div class="postbox-header">
								<h2 class="hndle"><span><?php esc_html_e( 'Latest Payments', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></span></h2>
							</div>
							...
							<div class="inside">
													...
													foreach ( $columns as $column ) :
														...
														if ( 'pronamic_payment_title' === $custom_column ) :
															...
															printf(
																...
																esc_html( __( 'Show more details', 'pronamic-pay-with-mollie-for-woocommerce' ) )
															);
								...
								<?php else : ?>
									...
									<p><?php esc_html_e( 'No pending payments found.', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></p>
					...
					if ( count( $subscriptions_posts ) > 0 ) :
						...
						<div id="normal-sortables" class="meta-box-sortables ui-sortable">
							...
							<div class="postbox">
								<div class="postbox-header">
									<h2 class="hndle"><span><?php esc_html_e( 'Latest Subscriptions', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></span></h2>
								</div>
			...
			<div id="postbox-container-<?php echo \esc_attr( (string) $container_index ); ?>" class="postbox-container">
				<div id="side-sortables" class="meta-box-sortables ui-sortable">
					<?php if ( current_user_can( 'manage_options' ) ) : ?>
						...
						<div class="postbox">
							<div class="postbox-header">
								<h2 class="hndle"><span><?php esc_html_e( 'Getting Started', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></span></h2>
							</div>

							<div class="inside">
								<p>
									<?php esc_html_e( "Please follow the tour, read the 'What is new' and 'Getting Started' pages before contacting us. Also, check the Site Health page for any issues.", 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
								</p>
								...
								printf(
									...
									esc_html__( 'Start tour', 'pronamic-pay-with-mollie-for-woocommerce' )
								);
								...
								if ( isset( $this ) && null !== $this->plugin->get_option( 'about_page_file' ) ) {
									printf(
										...
										esc_html__( 'What is new', 'pronamic-pay-with-mollie-for-woocommerce' )
									);
									...
									printf(
										...
										esc_html__( 'Getting started', 'pronamic-pay-with-mollie-for-woocommerce' )
									);
								...
								if ( version_compare( get_bloginfo( 'version' ), '5.2', '>=' ) && current_user_can( 'view_site_health_checks' ) ) :
									...
									printf(
										...
										esc_html__( 'Site Health', 'pronamic-pay-with-mollie-for-woocommerce' )
									);
								...
								if ( version_compare( get_bloginfo( 'version' ), '5.2', '<' ) ) :
									...
									printf(
										...
										esc_html__( 'System Status', 'pronamic-pay-with-mollie-for-woocommerce' )
									);
					...
					<div class="postbox">
						<div class="postbox-header">
							<h2 class="hndle"><span><?php esc_html_e( 'Pronamic News', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></span></h2>
						</div>
						...
						<div class="inside">
							...
							wp_widget_rss_output(
								...
								[
									'link'  => __( 'http://www.pronamic.eu/', 'pronamic-pay-with-mollie-for-woocommerce' ),
									'url'   => 'http://feeds.feedburner.com/pronamic',
									'title' => __( 'Pronamic News', 'pronamic-pay-with-mollie-for-woocommerce' ),
									'items' => 5,
								]
							);
