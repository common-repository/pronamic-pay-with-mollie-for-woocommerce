	...
	switch ( $message_id ) {
		case 'pages-generated':
			printf(
				...
				esc_html__( 'The default payment status pages are created.', 'pronamic-pay-with-mollie-for-woocommerce' )
			);
		...
		case 'pages-not-generated':
			printf(
				...
				esc_html__( 'The default payment status pages could not be created.', 'pronamic-pay-with-mollie-for-woocommerce' )
			);
