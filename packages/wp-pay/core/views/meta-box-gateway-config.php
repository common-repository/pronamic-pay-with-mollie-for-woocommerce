		...
		<tr>
			<th scope="row">
				<label for="pronamic_gateway_id">
					<?php esc_html_e( 'Payment provider', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</label>
			</th>
			<td>
				<select id="pronamic_gateway_id" name="_pronamic_gateway_id">
					...
					foreach ( $integrations as $integration ) {
						...
						if ( $integration->deprecated ) {
							...
							$name = sprintf( __( '%s (obsoleted)', 'pronamic-pay-with-mollie-for-woocommerce' ), $name );
						...
						if ( null !== $integration->get_product_url() ) {
							$links[] = sprintf(
								...
								\esc_html__( 'Product information', 'pronamic-pay-with-mollie-for-woocommerce' )
							);
						}
						...
						if ( null !== $manual_url ) {
							$links[] = sprintf(
								...
								\esc_html__( 'Manual', 'pronamic-pay-with-mollie-for-woocommerce' )
							);
						}
