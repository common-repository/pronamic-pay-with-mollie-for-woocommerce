...
if ( empty( $lines ) ) : ?>
	...
	<p>
		<?php \esc_html_e( 'No payment lines found.', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
	</p>
...
<?php else : ?>
	...
	<div class="pronamic-pay-table-responsive">
		<table class="pronamic-pay-table widefat">
			<thead>
				<tr>
					<th scope="col"><?php \esc_html_e( 'ID', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<th scope="col"><?php \esc_html_e( 'SKU', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<th scope="col"><?php \esc_html_e( 'Image', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<th scope="col"><?php \esc_html_e( 'Name', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<th scope="col">
						<?php

						\printf(
							'<span class="pronamic-pay-tip" title="%s">%s</span>',
							\esc_attr__( 'Unit price with discount including tax.', 'pronamic-pay-with-mollie-for-woocommerce' ),
							\esc_html__( 'Unit Price', 'pronamic-pay-with-mollie-for-woocommerce' )
						);

						?>
					</th>
					<th scope="col"><?php \esc_html_e( 'Quantity', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<th scope="col">
						<?php

						\printf(
							'<span class="pronamic-pay-tip" title="%s">%s</span>',
							\esc_attr__( 'Total discount.', 'pronamic-pay-with-mollie-for-woocommerce' ),
							\esc_html__( 'Discount', 'pronamic-pay-with-mollie-for-woocommerce' )
						);
					...
					<th scope="col">
						...
						\printf(
							'<span class="pronamic-pay-tip" title="%s">%s</span>',
							\esc_attr__( 'Total amount with discount including tax.', 'pronamic-pay-with-mollie-for-woocommerce' ),
							\esc_html__( 'Total Amount', 'pronamic-pay-with-mollie-for-woocommerce' )
						);

						?>
					</th>
					<th scope="col"><?php \esc_html_e( 'Total Tax', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
				</tr>
			</thead>
				...
				<?php foreach ( $lines as $line ) : ?>
					...
					<tr>
						...
						<td>
							...
							if ( null !== $unit_price ) {
								$tips = [
									\__( 'No tax information.', 'pronamic-pay-with-mollie-for-woocommerce' ),
								];
								...
								if ( $unit_price instanceof TaxedMoney ) {
									$tips = [
										\sprintf(
											...
											\__( 'Exclusive tax: %s', 'pronamic-pay-with-mollie-for-woocommerce' ),
											$unit_price->get_excluding_tax()
										),
										\sprintf(
											/* translators: %s: price including tax */
											\__( 'Inclusive tax: %s', 'pronamic-pay-with-mollie-for-woocommerce' ),
