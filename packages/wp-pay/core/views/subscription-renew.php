...
<html <?php language_attributes(); ?>>
	<head>
		...
		<title><?php esc_html_e( 'Subscription Renewal', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></title>
	...
	<body>
		<div class="pronamic-pay-redirect-page">
			<div class="pronamic-pay-redirect-container">
				<h1><?php esc_html_e( 'Subscription Renewal', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></h1>
				...
				<div class="pp-page-section-container">
					<div class="pp-page-section-wrapper alignleft">
						...
						<?php if ( null === $next_period ) : ?>
							...
							<p>
								<?php echo esc_html__( 'This subscription can not be renewed.', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
							</p>
						...
						<?php else : ?>
							...
							<p>
								...
								printf(
									...
									esc_html( __( 'Renew the subscription by paying for the period %s.', 'pronamic-pay-with-mollie-for-woocommerce' ) ),
									esc_html( $next_period->human_readable_range( __( 'l j F Y', 'pronamic-pay-with-mollie-for-woocommerce' ), _x( 'until', 'period separator', 'pronamic-pay-with-mollie-for-woocommerce' ) ) )
								);
