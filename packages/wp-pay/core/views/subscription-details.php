...
$details = [
	[
		'term'        => __( 'Description', 'pronamic-pay-with-mollie-for-woocommerce' ),
...
if ( null !== $phase ) {
	// Amount.
	$details[] = [
		'term'        => __( 'Amount', 'pronamic-pay-with-mollie-for-woocommerce' ),
...
if ( ! empty( $payment_method ) ) {
	$details[] = [
		'term'        => __( 'Payment method', 'pronamic-pay-with-mollie-for-woocommerce' ),
...
// Recurrence.
$details[] = [
	'term'        => __( 'Recurrence', 'pronamic-pay-with-mollie-for-woocommerce' ),
	'description' => $recurrence,
];

?>

<h2><?php esc_html_e( 'Subscription', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></h2>
