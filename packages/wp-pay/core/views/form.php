...
if ( empty( $action_url ) ) {
	esc_html_e( 'It is currently not possible to pay, please contact us for more information (error: no action URL found).', 'pronamic-pay-with-mollie-for-woocommerce' );
...
<form id="pronamic_ideal_form" name="pronamic_ideal_form" method="post" action="<?php echo esc_url( $action_url ); ?>">
	...
	<input class="pronamic-pay-btn" type="submit" name="pay" value="<?php esc_attr_e( 'Pay', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>" />
</form>
