...
<html <?php language_attributes(); ?>>
	<head>
		...
		<title><?php esc_html_e( 'Change subscription payment method', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></title>
	...
	<body>
		<div class="pronamic-pay-redirect-page">
			<div class="pronamic-pay-redirect-container">
				...
				<h1>
					<?php \esc_html_e( 'Change subscription payment method', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</h1>

				<?php if ( count( $mollie_customer_mandates ) > 0 ) : ?>

					<p>
						<?php \esc_html_e( 'Select an existing payment method or add a new one.', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
					</p>
					...
					<div class="pp-card-slider-container">
						<div class="pp-card-slider-wrapper">
							<form method="post">
								<h2>
									<?php \esc_html_e( 'Select existing payment method', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
								</h2>
									...
									foreach ( $mollie_customer_mandates as $mandate ) :
										...
										switch ( $mandate->method ) {
											case 'creditcard':
												...
												$account_label  = _x( 'Card Number', 'Card selector', 'pronamic-pay-with-mollie-for-woocommerce' );
											...
											case 'directdebit':
												...
												$account_label  = _x( 'Account Number', 'Card selector', 'pronamic-pay-with-mollie-for-woocommerce' );
											...
											<div class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>" style="background: <?php echo \esc_attr( $bg_color ); ?>;">
												...
												<div class="pp-card__content">
													...
													<dl class="pp-card__name">
														<dt class="pp-card__label"><?php echo esc_html_x( 'Name', 'Card selector', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></dt>
								...
								<p>
									...
									<input type="submit" value="<?php esc_attr_e( 'Use selected payment method', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>" />
								</p>
							</form>
						</div>
					</div>
				...
				<div class="pp-new-payment-method-container">
					<div class="pp-new-payment-method-wrapper">
						<form method="post">
							<h2>
								<?php \esc_html_e( 'Add new payment method', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
							</h2>

							<label>
								<p>
									<?php esc_html_e( 'Select payment method for verification payment.', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
								</p>
							...
							<p>
								...
								<input type="submit" value="<?php esc_attr_e( 'Pay', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>" />
							</p>
						</form>
					</div>
				</div>
