...
<table class="form-table">
	<tr>
		<th scope="row">
			<?php esc_html_e( 'Date', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
		</th>
		<td>
	...
	if ( PaymentStatus::FAILURE === $payment->get_status() && null !== $failure_reason ) :
		...
		<tr>
			<th scope="row">
				<?php esc_html_e( 'Status', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
			</th>
			<td>
				<?php
	...
	<tr>
		<th scope="row">
			<?php esc_html_e( 'ID', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
		</th>
		<td>
	...
	<tr>
		<th scope="row">
			<?php esc_html_e( 'Order ID', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
		</th>
		<td>
	...
	<tr>
		<th scope="row">
			<?php esc_html_e( 'Description', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
		</th>
		<td>
	...
	<tr>
		<th scope="row">
			<?php esc_html_e( 'Amount', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
		</th>
		<td>
			<?php
	...
	if ( $amount_refunded->get_value() > 0 ) :
		...
		<tr>
			<th scope="row">
				<?php esc_html_e( 'Refunded Amount', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
			</th>
			<td>
	...
	if ( null !== $charged_back_amount && $charged_back_amount->get_value() > 0 ) :
		...
		<tr>
			<th scope="row">
				<?php esc_html_e( 'Charged Back Amount', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
			</th>
			<td>
	...
	<tr>
		<th scope="row">
			<?php esc_html_e( 'Transaction ID', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
		</th>
		<td>
			<?php
	...
	if ( $purchase_id ) :
		...
		<tr>
			<th scope="row">
				<?php esc_html_e( 'Purchase ID', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
			</th>
			<td>
	...
	<?php if ( null !== $payment->config_id ) : ?>
		...
		<tr>
			<th scope="row">
				<?php esc_html_e( 'Gateway', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
			</th>
			<td>
	...
	<tr>
		<th scope="row">
			<?php esc_html_e( 'Payment Method', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
		</th>
		<td>
			<?php
	...
	if ( null !== $consumer_bank_details ) :
		...
		if ( null !== $consumer_name ) :
			...
			<tr>
				<th scope="row">
					<?php esc_html_e( 'Account Holder', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</th>
				<td>
		...
		if ( null !== $account_holder_city ) :
			...
			<tr>
				<th scope="row">
					<?php esc_html_e( 'Account Holder City', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</th>
				<td>
		...
		if ( null !== $account_holder_country ) :
			...
			<tr>
				<th scope="row">
					<?php esc_html_e( 'Account Holder Country', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</th>
				<td>
		...
		if ( null !== $account_number ) :
			...
			<tr>
				<th scope="row">
					<?php esc_html_e( 'Account Number', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</th>
				<td>
		...
		if ( null !== $iban ) :
			...
			<tr>
				<th scope="row">
					...
					printf(
						'<abbr title="%s">%s</abbr>',
						esc_attr( _x( 'International Bank Account Number', 'IBAN abbreviation title', 'pronamic-pay-with-mollie-for-woocommerce' ) ),
						esc_html__( 'IBAN', 'pronamic-pay-with-mollie-for-woocommerce' )
					);
		...
		if ( null !== $bic ) :
			...
			<tr>
				<th scope="row">
					...
					printf(
						'<abbr title="%s">%s</abbr>',
						esc_attr( _x( 'Bank Identifier Code', 'BIC abbreviation title', 'pronamic-pay-with-mollie-for-woocommerce' ) ),
						esc_html__( 'BIC', 'pronamic-pay-with-mollie-for-woocommerce' )
					);
	...
	<?php if ( null !== $bank_transfer_recipient ) : ?>
		...
		<tr>
			<th scope="row">
				<?php esc_html_e( 'Bank Transfer Recipient', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
			</th>
			<td>
				<?php
	...
	if ( null !== $customer ) :
		...
		if ( ! empty( $text ) ) :
			...
			<tr>
				<th scope="row">
					<?php esc_html_e( 'Customer', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</th>
				<td>
		...
		if ( null !== $company_name ) :
			...
			<tr>
				<th scope="row">
					<?php \esc_html_e( 'Company', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</th>
				<td>
		...
		if ( null !== $vat_number ) :
			...
			<tr>
				<th scope="row">
					<?php esc_html_e( 'VAT Number', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</th>
				<td>
			...
			<?php if ( null !== $vat_number_validity ) : ?>
				...
				<tr>
					<th scope="row">
						<?php esc_html_e( 'VAT Number Validity', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
					</th>
					<td style="padding-top: 20px">
						<table class="pronamic-pay-form-sub-table">
							...
							<tr>
								<th scope="row">
									<?php esc_html_e( 'Request Date', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
								</th>
								<td>
							...
							<tr>
								<th scope="row">
									<?php esc_html_e( 'Valid', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
								</th>
								<td>
									<?php echo esc_html( $vat_number_validity->is_valid() ? __( 'Yes', 'pronamic-pay-with-mollie-for-woocommerce' ) : __( 'No', 'pronamic-pay-with-mollie-for-woocommerce' ) ); ?>
								</td>
							</tr>
							<tr>
								<th scope="row">
									<?php esc_html_e( 'Name', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
								</th>
								<td>
							...
							<tr>
								<th scope="row">
									<?php esc_html_e( 'Address', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
								</th>
								<td>
									<?php
							...
							if ( null !== $service ) :
								...
								<tr>
									<th scope="row">
										<?php esc_html_e( 'Validation Service', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
									</th>
									<td>
										<?php
										...
										switch ( $service ) {
											case VatNumberValidationService::VIES:
												echo esc_html( __( 'VIES', 'pronamic-pay-with-mollie-for-woocommerce' ) );
		...
		if ( null !== $birth_date ) :
			...
			<tr>
				<th scope="row">
					<?php esc_html_e( 'Date of birth', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</th>
				<td>
					<?php

					echo esc_html( $birth_date->format_i18n( __( 'D j M Y', 'pronamic-pay-with-mollie-for-woocommerce' ) ) )
		...
		if ( null !== $gender ) :
			...
			<tr>
				<th scope="row">
					<?php esc_html_e( 'Gender', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</th>
				<td>
					<?php
					...
					switch ( $gender ) {
						case Gender::FEMALE:
							echo esc_html( __( 'Female', 'pronamic-pay-with-mollie-for-woocommerce' ) );

							break;
						case Gender::MALE:
							echo esc_html( __( 'Male', 'pronamic-pay-with-mollie-for-woocommerce' ) );

							break;
						case Gender::OTHER:
							echo esc_html( __( 'Other', 'pronamic-pay-with-mollie-for-woocommerce' ) );
		...
		if ( null !== $user_id ) :
			...
			<tr>
				<th scope="row">
					<?php esc_html_e( 'User', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</th>
				<td>
					<?php
		...
		if ( null !== $ip_address ) :
			...
			<tr>
				<th scope="row">
					<?php esc_html_e( 'IP Address', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</th>
				<td>
	...
	<?php if ( null !== $payment->get_billing_address() ) : ?>
		...
		<tr>
			<th scope="row">
				<?php esc_html_e( 'Billing Address', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
			</th>
			<td>
				<?php
	...
	<?php if ( null !== $payment->get_shipping_address() ) : ?>
		...
		<tr>
			<th scope="row">
				<?php esc_html_e( 'Shipping Address', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
			</th>
			<td>
				<?php
	...
	<tr>
		<th scope="row">
			<?php esc_html_e( 'Source', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
		</th>
		<td>
			<?php
	...
	<?php if ( 'membership' === $payment->get_source() ) : ?>
		...
		<tr>
			<th scope="row">
				<?php esc_html_e( 'User ID', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<?php esc_html_e( 'Subscription ID', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
			</th>
			<td>
	...
	<?php if ( ! empty( $ogone_alias ) && \is_string( $ogone_alias ) ) : ?>
		...
		<tr>
			<th scope="row">
				<?php esc_html_e( 'Ingenico Alias', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
			</th>
			<td>
	...
	<?php if ( $plugin->is_debug_mode() ) : ?>
		...
		<?php if ( null !== $payment->get_version() ) : ?>
			...
			<tr>
				<th scope="row">
					<?php esc_html_e( 'Version', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</th>
				<td>
		...
		<?php if ( null !== $payment->get_mode() ) : ?>
			...
			<tr>
				<th scope="row">
					<?php esc_html_e( 'Mode', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</th>
				<td>
					<?php
					...
					switch ( $payment->get_mode() ) {
						case 'live':
							esc_html_e( 'Live', 'pronamic-pay-with-mollie-for-woocommerce' );

							break;
						case 'test':
							esc_html_e( 'Test', 'pronamic-pay-with-mollie-for-woocommerce' );
	...
	if ( null !== $customer ) :
		...
		if ( null !== $user_agent ) :
			...
			<tr>
				<th scope="row">
					<?php esc_html_e( 'User Agent', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</th>
				<td>
	...
	<tr>
		<th scope="row">
			<?php esc_html_e( 'Action URL', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
		</th>
		<td>
			<?php
	...
	<tr>
		<th scope="row">
			<?php esc_html_e( 'Pay Redirect URL', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
		</th>
		<td>
			<?php
	...
	<tr>
		<th scope="row">
			<?php esc_html_e( 'Return URL', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
		</th>
		<td>
			<?php
	...
	<tr>
		<th scope="row">
			<?php esc_html_e( 'Return Redirect URL', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
		</th>
		<td>
			<?php
	...
	<?php if ( $plugin->is_debug_mode() ) : ?>
		...
		<tr>
			<th scope="row">
				<?php esc_html_e( 'REST API URL', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
			</th>
			<td>
				<?php
