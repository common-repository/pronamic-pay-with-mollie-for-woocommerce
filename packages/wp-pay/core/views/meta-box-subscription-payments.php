...
if ( 0 === count( $payments ) ) : ?>
	...
	<?php esc_html_e( 'No payments found.', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
...
<?php else : ?>
	...
	<table class="pronamic-pay-table widefat">
		<thead>
			<tr>
				<th scope="col">
					<span class="pronamic-pay-tip pronamic-pay-icon pronamic-pay-status" title="<?php esc_attr_e( 'Status', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>"><?php esc_html_e( 'Status', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></span>
				</th>
				<th scope="col"><?php esc_html_e( 'Period', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
				<th scope="col"><?php esc_html_e( 'Payment', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
				<th scope="col"><?php esc_html_e( 'Transaction', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
				<th scope="col"><?php esc_html_e( 'Amount', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
				<th scope="col"><?php esc_html_e( 'Date', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
			</tr>
		</thead>
						...
						if ( in_array( $subscription->get_source(), [ 'woocommerce' ], true ) && null !== $next_payment_date ) :
							...
							echo wp_kses_post(
								sprintf(
									...
									__( 'Will be created on %s', 'pronamic-pay-with-mollie-for-woocommerce' ),
									\esc_html( $next_payment_date->format_i18n( __( 'D j M Y', 'pronamic-pay-with-mollie-for-woocommerce' ) ) )
								)
							);
						...
						elseif ( null !== $next_payment_delivery_date ) :
							...
							echo wp_kses_post(
								sprintf(
									...
									__( 'Will be created on %1$s or %2$s', 'pronamic-pay-with-mollie-for-woocommerce' ),
									\esc_html( $next_payment_delivery_date->format_i18n( __( 'D j M Y', 'pronamic-pay-with-mollie-for-woocommerce' ) ) ),
									\sprintf(
										'<a href="%1$s">%2$s</a>',
										\esc_url( $create_next_payment_url ),
										\esc_html( \__( 'create now', 'pronamic-pay-with-mollie-for-woocommerce' ) )
									)
								)
							);
								...
								\printf(
									...
									\esc_html(
										sprintf(
											...
											__( 'Retry payment #%d', 'pronamic-pay-with-mollie-for-woocommerce' ),
											$payment_id
										)
									)
								);
