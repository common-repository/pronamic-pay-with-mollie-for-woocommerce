...
<table class="form-table">
	<tr>
		...
		<td>
			<?php the_time( __( 'l jS \o\f F Y, h:ia', 'pronamic-pay-with-mollie-for-woocommerce' ) ); ?>
		</td>
	</tr>
	<tr>
		<th scope="row">
	...
	<tr>
		<th scope="row">
			<?php echo esc_html__( 'Recurrence', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
		</th>
		<td>
			<?php
	...
	if ( SubscriptionStatus::ACTIVE === $subscription->get_status() ) :
		...
		<tr>
			<th scope="row">
				<?php esc_html_e( 'Next Payment Date', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
			</th>
			<td>
				<?php
		...
		<tr>
			<th scope="row">
				<?php esc_html_e( 'Next Payment Delivery Date', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
			</th>
			<td>
				<?php
				...
				echo empty( $next_payment_delivery_date ) ? '—' : esc_html( $next_payment_delivery_date->format_i18n( __( 'D j M Y', 'pronamic-pay-with-mollie-for-woocommerce' ) ) );
	...
	<tr>
		<th scope="row">
			<?php esc_html_e( 'Cancel URL', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
		</th>
		<td>
			<?php
	...
	<tr>
		<th scope="row">
			<?php esc_html_e( 'Renewal URL', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
		</th>
		<td>
			<?php
	...
	<tr>
		<th scope="row">
			<?php esc_html_e( 'Change payment method URL', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
		</th>
		<td>
			<?php
