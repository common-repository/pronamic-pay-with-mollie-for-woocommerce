...
if ( null === $gateway ) {
	printf(
		'<em>%s</em>',
		esc_html( __( 'Please save the entered account details of your payment provider, to make a test payment.', 'pronamic-pay-with-mollie-for-woocommerce' ) )
	);
...
<table class="form-table">
		...
		<td>
			<select id="pronamic-pay-test-payment-methods" name="pronamic_pay_test_payment_method">
				<?php if ( count( $payment_methods ) > 1 ) : ?>
					...
					<option value=""><?php esc_html_e( '— Choose payment method —', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></option>
				...
				<td>
					...
					try {
						...
						printf(
							...
							esc_html__( 'This field could not be displayed due to the following error message: "%s".', 'pronamic-pay-with-mollie-for-woocommerce' ),
						...
						<div class="error">
							<p>
								...
								echo wp_kses(
									sprintf(
										...
										__( '<strong>Pronamic Pay</strong> — An error occurred within the "%1$s" field of the "%2$s" payment method.', 'pronamic-pay-with-mollie-for-woocommerce' ),
							...
							<dl>
								<dt><?php esc_html_e( 'Message', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></dt>
								<dd><?php echo esc_html( $exception->getMessage() ); ?></dd>

								<?php if ( 0 !== $exception->getCode() ) : ?>

									<dt><?php esc_html_e( 'Code', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></dt>
	...
	<?php if ( $gateway->supports( 'recurring' ) ) : ?>
		...
		$options = [
			''  => __( '— Select Repeat —', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'D' => __( 'Daily', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'W' => __( 'Weekly', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'M' => __( 'Monthly', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'Y' => __( 'Annually', 'pronamic-pay-with-mollie-for-woocommerce' ),
		];

		$options_interval_suffix = [
			'D' => __( 'days', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'W' => __( 'weeks', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'M' => __( 'months', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'Y' => __( 'year', 'pronamic-pay-with-mollie-for-woocommerce' ),
		];
		...
		<tr>
			<th scope="row">
				<label for="pronamic-pay-test-subscription">
					<?php esc_html_e( 'Subscription', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</label>
			</th>
			<td>
				<fieldset>
					<legend class="screen-reader-text"><span><?php esc_html_e( 'Test Subscription', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></span></legend>

					<label for="pronamic-pay-test-subscription">
						<input name="pronamic_pay_test_subscription" id="pronamic-pay-test-subscription" value="1" type="checkbox" />
						<?php esc_html_e( 'Start a subscription for this payment.', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
					</label>
				</fieldset>
		...
		<tr class="pronamic-pay-cloak pronamic-pay-test-subscription">
			<th scope="row">
				<label for="pronamic_pay_test_repeat_frequency"><?php esc_html_e( 'Frequency', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></label>
			</th>
			<td>
		...
		<tr class="pronamic-pay-cloak pronamic-pay-test-subscription">
			<th scope="row">
				<label for="pronamic_pay_test_repeat_interval"><?php esc_html_e( 'Repeat every', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></label>
			</th>
			<td>
				...
				<span id="pronamic_pay_test_repeat_interval_suffix"><?php esc_html_e( 'days/weeks/months/year', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></span>
			</td>
		</tr>
		<tr class="pronamic-pay-cloak pronamic-pay-test-subscription">
			<th scope="row">
				<?php esc_html_e( 'Ends On', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
			</th>
			<td>
				<div>
					...
					<label for="pronamic_pay_ends_never">
						<?php esc_html_e( 'Never', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
					</label>
				</div>
				<div>
					...
					<label for="pronamic_pay_ends_count">
						...
						echo wp_kses(
							sprintf(
								...
								__( 'After %s times', 'pronamic-pay-with-mollie-for-woocommerce' ),
					...
					<label for="pronamic_pay_ends_date">
						...
						echo wp_kses(
							sprintf(
								...
								__( 'On %s', 'pronamic-pay-with-mollie-for-woocommerce' ),
	...
	<tr>
		...
		<td>
			<?php submit_button( __( 'Test', 'pronamic-pay-with-mollie-for-woocommerce' ), 'secondary', 'test_pay_gateway', false ); ?>
		</td>
	</tr>
