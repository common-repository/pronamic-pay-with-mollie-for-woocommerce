...
<table class="form-table widefat pronamic-pay-payment-methods">
	<thead>
		<tr>
			<th scope="col"><?php esc_html_e( 'Payment Method', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
			<th scope="col"><?php esc_html_e( 'Status', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>

			<?php if ( $show_recurring_column ) : ?>

				<th scope="col"><?php esc_html_e( 'Recurring', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
