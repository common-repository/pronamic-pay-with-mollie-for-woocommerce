...
class SubscriptionsDataStoreCPT extends LegacyPaymentsDataStoreCPT {
	...
	private function register_meta() {
		...
		$this->register_meta_key(
			'frequency',
			[
				'label' => __( 'Frequency', 'pronamic-pay-with-mollie-for-woocommerce' ),
			]
		);
		...
		$this->register_meta_key(
			'interval',
			[
				'label' => __( 'Interval', 'pronamic-pay-with-mollie-for-woocommerce' ),
			]
		);
		...
		$this->register_meta_key(
			'interval_period',
			[
				'label' => __( 'Interval Period', 'pronamic-pay-with-mollie-for-woocommerce' ),
			]
		);
		...
		$this->register_meta_key(
			'payment_method',
			[
				'label'           => __( 'Payment Method', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
				'privacy_erasure' => 'erase',
			]
		);
