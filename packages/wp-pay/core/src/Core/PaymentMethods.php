...
class PaymentMethods {
	...
	public static function get_payment_methods() {
		$payment_methods = [
			self::AFTERPAY_NL             => _x( 'AfterPay', 'afterpay.nl', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::AFTERPAY_COM            => _x( 'Afterpay', 'afterpay.com', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::ALIPAY                  => __( 'Alipay', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::AMERICAN_EXPRESS        => __( 'American Express', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::APPLE_PAY               => __( 'Apple Pay', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::BANCONTACT              => __( 'Bancontact', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::BANK_TRANSFER           => __( 'Bank Transfer', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::BELFIUS                 => __( 'Belfius Direct Net', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::BILLIE                  => __( 'Billie', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::BILLINK                 => __( 'Billink', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::BITCOIN                 => __( 'Bitcoin', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::BLIK                    => __( 'BLIK', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::BUNQ                    => __( 'Bunq', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::CAPAYABLE               => __( 'Capayable', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::IN3                     => __( 'In3', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::CARD                    => __( 'Card', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::CREDIT_CARD             => __( 'Credit Card', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::DIRECT_DEBIT            => __( 'Direct Debit', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::DIRECT_DEBIT_BANCONTACT => sprintf(
				/* translators: %s: payment method */
				__( 'Direct Debit (mandate via %s)', 'pronamic-pay-with-mollie-for-woocommerce' ),
				__( 'Bancontact', 'pronamic-pay-with-mollie-for-woocommerce' )
			),
			self::DIRECT_DEBIT_IDEAL      => sprintf(
				/* translators: %s: payment method */
				__( 'Direct Debit (mandate via %s)', 'pronamic-pay-with-mollie-for-woocommerce' ),
				__( 'iDEAL', 'pronamic-pay-with-mollie-for-woocommerce' )
			),
			self::DIRECT_DEBIT_SOFORT     => sprintf(
				/* translators: %s: payment method */
				__( 'Direct Debit (mandate via %s)', 'pronamic-pay-with-mollie-for-woocommerce' ),
				__( 'SOFORT', 'pronamic-pay-with-mollie-for-woocommerce' )
			),
			self::EPS                     => __( 'EPS', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::FOCUM                   => __( 'Focum', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::GIROPAY                 => __( 'Giropay', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::GOOGLE_PAY              => __( 'Google Pay', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::IDEAL                   => __( 'iDEAL', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::IDEALQR                 => __( 'iDEAL QR', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::KBC                     => __( 'KBC/CBC Payment Button', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::KLARNA_PAY_LATER        => __( 'Klarna Pay Later', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::KLARNA_PAY_NOW          => __( 'Klarna Pay Now', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::KLARNA_PAY_OVER_TIME    => __( 'Klarna Pay Over Time', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::MAESTRO                 => __( 'Maestro', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::MASTERCARD              => __( 'Mastercard', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::MB_WAY                  => __( 'MB WAY', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::MOBILEPAY               => __( 'MobilePay', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::PAYCONIQ                => __( 'Payconiq', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::PAYPAL                  => __( 'PayPal', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::PRZELEWY24              => __( 'Przelewy24', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::RIVERTY                 => __( 'Riverty', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::SANTANDER               => __( 'Santander', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::SOFORT                  => __( 'SOFORT Banking', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::SPRAYPAY                => __( 'SprayPay', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::SWISH                   => __( 'Swish', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::TWINT                   => __( 'TWINT', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::V_PAY                   => __( 'V PAY', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::VIPPS                   => __( 'Vipps', 'pronamic-pay-with-mollie-for-woocommerce' ),
			self::VISA                    => __( 'Visa', 'pronamic-pay-with-mollie-for-woocommerce' ),
		];
