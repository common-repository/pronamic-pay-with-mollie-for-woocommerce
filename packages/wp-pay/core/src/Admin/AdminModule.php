...
class AdminModule {
	...
	public function maybe_test_payment() {
		...
		$description = \sprintf(
			...
			__( 'Test %s', 'pronamic-pay-with-mollie-for-woocommerce' ),
			$order_id
		);
		...
		$line->set_name( __( 'Test', 'pronamic-pay-with-mollie-for-woocommerce' ) );
	...
	public function admin_menu() {
		...
		$badges = [
			...
			'payments'      => [
				'title' => \sprintf(
					...
					\_n( '%d payment pending', '%d payments pending', $payments_pending_count, 'pronamic-pay-with-mollie-for-woocommerce' ),
			...
			'subscriptions' => [
				'title' => \sprintf(
					...
					\_n( '%d subscription on hold', '%d subscriptions on hold', $subscriptions_on_hold_count, 'pronamic-pay-with-mollie-for-woocommerce' ),
		...
		$submenu_pages[] = [
			'page_title' => __( 'Payments', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'menu_title' => __( 'Payments', 'pronamic-pay-with-mollie-for-woocommerce' ) . $badges['payments']['html'],
		...
		if ( \in_array( 'subscriptions', $modules, true ) ) {
			$submenu_pages[] = [
				'page_title' => __( 'Subscriptions', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'menu_title' => __( 'Subscriptions', 'pronamic-pay-with-mollie-for-woocommerce' ) . $badges['subscriptions']['html'],
				'capability' => 'edit_payments',
		...
		$submenu_pages[] = [
			'page_title' => __( 'Configurations', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'menu_title' => __( 'Configurations', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'capability' => 'manage_options',
			'menu_slug'  => 'edit.php?post_type=pronamic_gateway',
		];

		$submenu_pages[] = [
			'page_title' => __( 'Settings', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'menu_title' => __( 'Settings', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'capability' => 'manage_options',
		...
		add_menu_page(
			...
			__( 'Pay', 'pronamic-pay-with-mollie-for-woocommerce' ) . $pay_badge,
			$minimum_capability,
			'pronamic_ideal',
			function () {
		...
		if ( isset( $submenu['pronamic_ideal'] ) ) {
			...
			$submenu['pronamic_ideal'][0][0] = __( 'Dashboard', 'pronamic-pay-with-mollie-for-woocommerce' );
		}
	}
