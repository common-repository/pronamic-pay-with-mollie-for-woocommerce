...
class AdminGatewayPostType {
	...
	public function edit_columns( $columns ) {
		$columns = [
			...
			'pronamic_gateway_variant'   => __( 'Variant', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'pronamic_gateway_id'        => __( 'ID', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'pronamic_gateway_dashboard' => __( 'Dashboard', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'date'                       => __( 'Date', 'pronamic-pay-with-mollie-for-woocommerce' ),
		];
				...
				if ( isset( $integration ) ) {
					...
					if ( null !== $url ) {
						\printf(
							...
							esc_url( $url ),
							esc_html__( 'Dashboard', 'pronamic-pay-with-mollie-for-woocommerce' )
						);
					}
				}
	...
	public function display_post_states( $post_states, $post ) {
		...
		if ( intval( get_option( 'pronamic_pay_config_id' ) ) === $post->ID ) {
			$post_states['pronamic_pay_config_default'] = __( 'Default', 'pronamic-pay-with-mollie-for-woocommerce' );
		}
	...
	public function add_meta_boxes( $post_type ) {
		...
		add_meta_box(
			...
			__( 'Configuration', 'pronamic-pay-with-mollie-for-woocommerce' ),
		...
		add_meta_box(
			...
			__( 'Test', 'pronamic-pay-with-mollie-for-woocommerce' ),
			[ $this, 'meta_box_test' ],
			$post_type,
			'normal',
			'high'
	...
	public function post_updated_messages( $messages ) {
		...
		$messages[ self::POST_TYPE ] = [
			...
			1  => __( 'Configuration updated.', 'pronamic-pay-with-mollie-for-woocommerce' ),
			...
			4  => __( 'Configuration updated.', 'pronamic-pay-with-mollie-for-woocommerce' ),
			...
			5  => isset( $_GET['revision'] ) ? sprintf( __( 'Configuration restored to revision from %s.', 'pronamic-pay-with-mollie-for-woocommerce' ), strval( wp_post_revision_title( (int) $_GET['revision'], false ) ) ) : false,
			...
			6  => __( 'Configuration published.', 'pronamic-pay-with-mollie-for-woocommerce' ),
			...
			7  => __( 'Configuration saved.', 'pronamic-pay-with-mollie-for-woocommerce' ),
			...
			8  => __( 'Configuration submitted.', 'pronamic-pay-with-mollie-for-woocommerce' ),
			...
			9  => sprintf( __( 'Configuration scheduled for: %s.', 'pronamic-pay-with-mollie-for-woocommerce' ), '<strong>' . $scheduled_date . '</strong>' ),
			...
			10 => __( 'Configuration draft updated.', 'pronamic-pay-with-mollie-for-woocommerce' ),
		];
