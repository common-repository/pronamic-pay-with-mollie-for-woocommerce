...
class AdminSettings {
	...
	public function admin_init() {
		...
		add_settings_section(
			...
			__( 'General', 'pronamic-pay-with-mollie-for-woocommerce' ),
			function () {
			},
			'pronamic_pay'
		);
		...
		add_settings_field(
			...
			__( 'Default Gateway', 'pronamic-pay-with-mollie-for-woocommerce' ),
			[ $this, 'input_page' ],
			'pronamic_pay',
			'pronamic_pay_general',
			[
				'post_type'        => 'pronamic_gateway',
				'show_option_none' => __( '— Select a gateway —', 'pronamic-pay-with-mollie-for-woocommerce' ),
		...
		add_settings_field(
			...
			__( 'Remove Data', 'pronamic-pay-with-mollie-for-woocommerce' ),
			[ $this, 'input_checkbox' ],
			'pronamic_pay',
			'pronamic_pay_general',
			[
				'legend'      => __( 'Remove Data', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'description' => __( 'Remove all plugin data on uninstall', 'pronamic-pay-with-mollie-for-woocommerce' ),
		...
		// Debug mode.
		$debug_mode_args = [
			'legend'      => \__( 'Debug Mode', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'description' => \__( 'Enable debug mode', 'pronamic-pay-with-mollie-for-woocommerce' ),
		...
		\add_settings_field(
			...
			\__( 'Debug Mode', 'pronamic-pay-with-mollie-for-woocommerce' ),
			[ $this, 'input_checkbox' ],
			'pronamic_pay',
			'pronamic_pay_general',
			$debug_mode_args
		...
		if ( $this->plugin->is_debug_mode() || $this->plugin->subscriptions_module->is_processing_disabled() ) {
			\add_settings_field(
				...
				\__( 'Disable Recurring Payments', 'pronamic-pay-with-mollie-for-woocommerce' ),
				[ $this, 'input_checkbox' ],
				'pronamic_pay',
				'pronamic_pay_general',
				[
					'legend'      => \__( 'Disable starting recurring payments at gateway', 'pronamic-pay-with-mollie-for-woocommerce' ),
					'description' => \__( 'Disable starting recurring payments at gateway', 'pronamic-pay-with-mollie-for-woocommerce' ),
		...
		if ( version_compare( $this->plugin->get_version(), '10', '>=' ) ) {
			...
			\add_settings_section(
				...
				\__( 'Payment Methods', 'pronamic-pay-with-mollie-for-woocommerce' ),
				function () {
				},
				'pronamic_pay'
			);
	...
	public function input_page( $args ) {
		...
		wp_dropdown_pages(
			[
				...
				'show_option_none' => esc_attr( isset( $args['show_option_none'] ) ? $args['show_option_none'] : __( '— Select a page —', 'pronamic-pay-with-mollie-for-woocommerce' ) ),
				'class'            => 'regular-text',
			]
		);
	}
	...
	public function select_payment_method_status( $args ) {
		...
		$statuses = [
			''         => '',
			'active'   => \__( 'Active', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'inactive' => \__( 'Inactive', 'pronamic-pay-with-mollie-for-woocommerce' ),
		];
