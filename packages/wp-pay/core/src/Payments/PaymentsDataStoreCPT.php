...
class PaymentsDataStoreCPT extends LegacyPaymentsDataStoreCPT {
	...
	private function register_meta() {
		$this->register_meta_key(
			'config_id',
			[
				'label' => __( 'Config ID', 'pronamic-pay-with-mollie-for-woocommerce' ),
			]
		);
		...
		$this->register_meta_key(
			'key',
			[
				'label' => __( 'Key', 'pronamic-pay-with-mollie-for-woocommerce' ),
			]
		);
		...
		$this->register_meta_key(
			'method',
			[
				'label'           => __( 'Method', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
		...
		$this->register_meta_key(
			'currency',
			[
				'label'          => __( 'Currency', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export' => true,
			]
		);
		...
		$this->register_meta_key(
			'amount',
			[
				'label'          => __( 'Amount', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export' => true,
			]
		);
		...
		$this->register_meta_key(
			'issuer',
			[
				'label'           => __( 'Issuer', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
				'privacy_erasure' => 'erase',
			]
		);
		...
		$this->register_meta_key(
			'order_id',
			[
				'label'          => __( 'Order ID', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export' => true,
			]
		);
		...
		$this->register_meta_key(
			'transaction_id',
			[
				'label' => __( 'Transaction ID', 'pronamic-pay-with-mollie-for-woocommerce' ),
			]
		);
		...
		$this->register_meta_key(
			'entrance_code',
			[
				'label'           => __( 'Entrance Code', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_erasure' => 'erase',
			]
		);
		...
		$this->register_meta_key(
			'action_url',
			[
				'label'           => __( 'Action URL', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_erasure' => 'erase',
			]
		);
		...
		$this->register_meta_key(
			'source',
			[
				'label' => __( 'Source', 'pronamic-pay-with-mollie-for-woocommerce' ),
			]
		);
		...
		$this->register_meta_key(
			'source_id',
			[
				'label' => __( 'Source ID', 'pronamic-pay-with-mollie-for-woocommerce' ),
			]
		);
		...
		$this->register_meta_key(
			'description',
			[
				'label'           => __( 'Description', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
				'privacy_erasure' => 'erase',
			]
		);
		...
		$this->register_meta_key(
			'language',
			[
				'label'           => __( 'Language', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_erasure' => 'erase',
			]
		);
		...
		$this->register_meta_key(
			'locale',
			[
				'label'           => __( 'Locale', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
				'privacy_erasure' => 'erase',
			]
		);
		...
		$this->register_meta_key(
			'email',
			[
				'label'           => __( 'Email', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
		...
		$this->register_meta_key(
			'status',
			[
				'label'          => __( 'Status', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export' => true,
			]
		);
		...
		$this->register_meta_key(
			'customer_name',
			[
				'label'           => __( 'Customer Name', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
				'privacy_erasure' => 'erase',
			]
		);
		...
		$this->register_meta_key(
			'address',
			[
				'label'           => __( 'Address', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
				'privacy_erasure' => 'erase',
			]
		);
		...
		$this->register_meta_key(
			'postal_code',
			[
				'label'           => __( 'Postal Code', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
				'privacy_erasure' => 'erase',
			]
		);
		...
		$this->register_meta_key(
			'city',
			[
				'label'           => __( 'City', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
				'privacy_erasure' => 'erase',
			]
		);
		...
		$this->register_meta_key(
			'country',
			[
				'label'           => __( 'Country', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
				'privacy_erasure' => 'erase',
			]
		);
		...
		$this->register_meta_key(
			'telephone_number',
			[
				'label'           => __( 'Telephone Number', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
				'privacy_erasure' => 'erase',
			]
		);
		...
		$this->register_meta_key(
			'consumer_name',
			[
				'label'           => __( 'Consumer Name', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
				'privacy_erasure' => 'erase',
			]
		);
		...
		$this->register_meta_key(
			...
			[
				'label'           => __( 'Consumer Account Number', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
				'privacy_erasure' => 'erase',
			]
		);
		...
		$this->register_meta_key(
			'consumer_iban',
			[
				'label'           => __( 'Consumer IBAN', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
				'privacy_erasure' => 'erase',
			]
		);
		...
		$this->register_meta_key(
			'consumer_bic',
			[
				'label'           => __( 'Consumer BIC', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
				'privacy_erasure' => 'erase',
			]
		);
		...
		$this->register_meta_key(
			'consumer_city',
			[
				'label'           => __( 'Consumer City', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
				'privacy_erasure' => 'erase',
			]
		);
		...
		$this->register_meta_key(
			'subscription_id',
			[
				'label'          => __( 'Subscription ID', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export' => true,
			]
		);
		...
		$this->register_meta_key(
			'recurring_type',
			[
				'label'          => __( 'Recurring Type', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export' => true,
			]
		);
		...
		$this->register_meta_key(
			'recurring',
			[
				'label' => __( 'Recurring', 'pronamic-pay-with-mollie-for-woocommerce' ),
			]
		);
		...
		$this->register_meta_key(
			'start_date',
			[
				'label'          => __( 'Start Date', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export' => true,
			]
		);
		...
		$this->register_meta_key(
			'end_date',
			[
				'label'          => __( 'End Date', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export' => true,
			]
		);
		...
		$this->register_meta_key(
			'user_agent',
			[
				'label'           => __( 'User Agent', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
				'privacy_erasure' => 'erase',
			]
		);
		...
		$this->register_meta_key(
			'user_ip',
			[
				'label'           => __( 'User IP', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'privacy_export'  => true,
				'privacy_erasure' => 'erase',
			]
		);
