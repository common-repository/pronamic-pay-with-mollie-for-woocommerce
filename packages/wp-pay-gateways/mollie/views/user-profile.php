...
?>
<h2><?php esc_html_e( 'Mollie', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></h2>
...
<table class="form-table" id="fieldset-billing">
	<tbody>
		<tr>
			<th>
				<?php echo esc_html( _x( 'Customers', 'mollie', 'pronamic-pay-with-mollie-for-woocommerce' ) ); ?>
			</th>
			<td>
				<table class="widefat striped pronamic-pay-mollie-customers-table">
					<thead>
						<tr>
							...
							<th scope="col"><?php \esc_html_e( 'Test', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
							<th scope="col"><?php \esc_html_e( 'Name', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
							<th scope="col"><?php \esc_html_e( 'Email', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
						</tr>
					</thead>
					...
					<tbody>
						...
						<?php foreach ( $customers as $customer ) : ?>
							...
							<tr>
								...
								<td>
									<?php $customer->test_mode ? \esc_html_e( 'Yes', 'pronamic-pay-with-mollie-for-woocommerce' ) : \esc_html_e( 'No', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
								</td>
								<td>
