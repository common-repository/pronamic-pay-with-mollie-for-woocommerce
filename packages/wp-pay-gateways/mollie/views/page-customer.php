...
<div class="wrap">
	...
	echo \wp_kses(
		\sprintf(
			...
			\__( 'Customer %s', 'pronamic-pay-with-mollie-for-woocommerce' ),
			\sprintf(
				'<code>%s</code>',
				$mollie_customer_id
			)
	...
	<table class="form-table">
		<tbody>
			<tr>
				<th scope="row"><?php \esc_html_e( 'ID', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
				<td>
					<code><?php echo \esc_html( $mollie_customer_data->id ); ?></code>
				</td>
			</tr>
			<tr>
				<th scope="row"><?php \esc_html_e( 'Mode', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
				<td>
					<?php $mollie_customer_data->test_mode ? \esc_html_e( 'Test', 'pronamic-pay-with-mollie-for-woocommerce' ) : \esc_html_e( 'Live', 'pronamic-pay-with-mollie-for-woocommerce' ); ?>
				</td>
			</tr>
			<tr>
				<th scope="row"><?php \esc_html_e( 'Name', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
				<td>
					<?php echo \esc_html( $mollie_customer_data->name ); ?>
				</td>
			</tr>
			<tr>
				<th scope="row"><?php \esc_html_e( 'Email', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
				<td>
					<?php
			...
			<?php if ( null !== $mollie_customer ) : ?>
				...
				<tr>
					<th scope="row"><?php \esc_html_e( 'Locale', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<td>
						<?php
			...
			<tr>
				<th scope="row"><?php \esc_html_e( 'Link', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
				<td>
					<?php
	...
	<?php if ( null !== $mollie_customer_mandates ) : ?>
		...
		<h3><?php \esc_html_e( 'Mandates', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></h3>

		<table class="widefat">
			<thead>
				<tr>
					<th><?php \esc_html_e( 'ID', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<th><?php \esc_html_e( 'Mode', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<th><?php \esc_html_e( 'Status', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<th><?php \esc_html_e( 'Method', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<th><?php \esc_html_e( 'Details', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<th><?php \esc_html_e( 'Mandate Reference', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<th><?php \esc_html_e( 'Signature Date', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<th><?php \esc_html_e( 'Created On', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
				</tr>
			</thead>
			...
			<tbody>
				...
				<?php if ( empty( $mollie_customer_mandates ) ) : ?>
					...
					<tr>
						<td colspan="4"><?php esc_html_e( 'No mandates found.', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></td>
					</tr>
						...
						<tr>
							...
							<td>
								...
								switch ( $mandate->status ) {
									case 'pending':
										\esc_html_e( 'Pending', 'pronamic-pay-with-mollie-for-woocommerce' );

										break;
									case 'valid':
										\esc_html_e( 'Valid', 'pronamic-pay-with-mollie-for-woocommerce' );
							...
							<td>
								...
								switch ( $mandate->method ) {
									case 'creditcard':
										\esc_html_e( 'Credit Card', 'pronamic-pay-with-mollie-for-woocommerce' );

										break;
									case 'directdebit':
										\esc_html_e( 'Direct Debit', 'pronamic-pay-with-mollie-for-woocommerce' );
									...
									case 'creditcard':
										...
										<dl style="margin: 0;">
											...
											<?php if ( ! empty( $mandate->details->cardHolder ) ) : ?>
												...
												<dt><?php \esc_html_e( 'Card Holder', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></dt>
												<dd>
											...
											<?php if ( ! empty( $mandate->details->cardNumber ) ) : ?>
												...
												<dt><?php \esc_html_e( 'Card Number', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></dt>
												<dd>
											...
											<?php if ( ! empty( $mandate->details->cardLabel ) ) : ?>
												...
												<dt><?php \esc_html_e( 'Card Label', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></dt>
												<dd>
											...
											<?php if ( ! empty( $mandate->details->cardFingerprint ) ) : ?>
												...
												<dt><?php \esc_html_e( 'Card Fingerprint', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></dt>
												<dd>
											...
											<?php if ( ! empty( $mandate->details->cardExpiryDate ) ) : ?>
												...
												<dt><?php \esc_html_e( 'Card Expiry Date', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></dt>
												<dd>
									...
									case 'directdebit':
										...
										<dl style="margin: 0;">
											...
											<?php if ( ! empty( $mandate->details->consumerName ) ) : ?>
												...
												<dt><?php \esc_html_e( 'Consumer Name', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></dt>
												<dd>
											...
											<?php if ( ! empty( $mandate->details->consumerAccount ) ) : ?>
												...
												<dt><?php \esc_html_e( 'Consumer Account', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></dt>
												<dd>
											...
											<?php if ( ! empty( $mandate->details->consumerBic ) ) : ?>
												...
												<dt><?php \esc_html_e( 'Consumer BIC', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></dt>
												<dd>
	...
	<?php if ( ! empty( $users ) ) : ?>
		...
		<h3><?php \esc_html_e( 'WordPress Users', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></h3>

		<table class="widefat">
			<thead>
				<tr>
					<th><?php \esc_html_e( 'ID', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<th><?php \esc_html_e( 'Email', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<th><?php \esc_html_e( 'Display Name', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
				</tr>
			</thead>
