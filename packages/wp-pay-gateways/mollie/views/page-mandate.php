...
<div class="wrap">
	...
	<h2>
		...
		echo \wp_kses(
			\sprintf(
				...
				\__( 'Mandate %s', 'pronamic-pay-with-mollie-for-woocommerce' ),
				\sprintf(
					'<code>%s</code>',
					$mollie_mandate_id
				)
	...
	<table class="form-table">
		<tbody>
			<tr>
				<th scope="row"><?php \esc_html_e( 'Customer ID', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
				<td>
					<code><?php echo \esc_html( $mollie_customer_id ); ?></code>
				</td>
			</tr>
			<tr>
				<th scope="row"><?php \esc_html_e( 'Mandate ID', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
				<td>
			...
			<?php if ( $mollie_mandate ) : ?>
				...
				<tr>
					<th scope="row"><?php \esc_html_e( 'Status', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<td>
						<?php
						...
						switch ( $mollie_mandate->status ) {
							...
							case 'pending':
								...
								break;
							case 'invalid':
								\esc_html_e( 'Invalid', 'pronamic-pay-with-mollie-for-woocommerce' );
								break;
							default:
				...
				<tr>
					<th scope="row"><?php \esc_html_e( 'Method', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<td>
						<?php
						...
						switch ( $mollie_mandate->method ) {
							...
							case 'creditcard':
								...
								break;
							case 'paypal':
								\esc_html_e( 'PayPal', 'pronamic-pay-with-mollie-for-woocommerce' );
								break;
							default:
				...
				<tr>
					<th scope="row"><?php \esc_html_e( 'Details', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<td>
				...
				<tr>
					<th scope="row"><?php \esc_html_e( 'Reference', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<td>
						<?php echo \esc_html( $object_access->get_optional( 'mandateReference' ) ); ?>
					</td>
				</tr>
				<tr>
					<th scope="row"><?php \esc_html_e( 'Signature date', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<td>
						<?php echo \esc_html( $object_access->get_optional( 'signatureDate' ) ); ?>
					</td>
				</tr>
				<tr>
					<th scope="row"><?php \esc_html_e( 'Created at', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<td>
