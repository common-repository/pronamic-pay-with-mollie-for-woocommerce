...
<div class="wrap">
	...
	echo \wp_kses(
		\sprintf(
			...
			\__( 'Payment %s', 'pronamic-pay-with-mollie-for-woocommerce' ),
			\sprintf(
				'<code>%s</code>',
				$mollie_payment_id
			)
		...
		<tbody>
			...
			<?php if ( null !== $payment ) : ?>
				...
				if ( ! empty( $url ) ) :
					...
					<tr>
						<th scope="row"><?php \esc_html_e( 'Change Payment State', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
						<td>
							<?php
							...
							\printf(
								...
								\esc_url( $url ),
								\esc_attr( \__( 'Change Payment State', 'pronamic-pay-with-mollie-for-woocommerce' ) ),
								\esc_html( $url )
							);
				...
				<tr>
					<th scope="row"><?php \esc_html_e( 'Pronamic Pay Payment', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<td>
						<?php
			...
			<?php if ( null !== $mollie_payment ) : ?>
				...
				<tr>
					<th scope="row"><?php \esc_html_e( 'Metadata', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
					<td>
			...
			<?php if ( pronamic_pay_plugin()->is_debug_mode() ) : ?>
				...
				<?php if ( null !== $command_curl ) : ?>
					...
					<tr>
						<th scope="row"><?php \esc_html_e( 'cURL', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
						<td>
				...
				<?php if ( null !== $command_httpie ) : ?>
					...
					<tr>
						<th scope="row"><?php \esc_html_e( 'HTTPie', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></th>
						<td>
