...
class Admin {
	...
	public function admin_menu() {
		...
		add_menu_page(
			__( 'Mollie', 'pronamic-pay-with-mollie-for-woocommerce' ),
			__( 'Mollie', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'manage_options',
			'pronamic_pay_mollie',
			[ $this, 'page_mollie' ],
		...
		add_submenu_page(
			'pronamic_pay_mollie',
			__( 'Mollie Profiles', 'pronamic-pay-with-mollie-for-woocommerce' ),
			__( 'Profiles', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'manage_options',
		...
		add_submenu_page(
			'pronamic_pay_mollie',
			__( 'Mollie Customers', 'pronamic-pay-with-mollie-for-woocommerce' ),
			__( 'Customers', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'manage_options',
		...
		add_submenu_page(
			'pronamic_pay_mollie',
			__( 'Mollie Mandates', 'pronamic-pay-with-mollie-for-woocommerce' ),
			__( 'Mandates', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'manage_options',
		...
		add_submenu_page(
			'pronamic_pay_mollie',
			__( 'Mollie Payments', 'pronamic-pay-with-mollie-for-woocommerce' ),
