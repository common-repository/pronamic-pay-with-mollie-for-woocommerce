...
class WebhookController {
	...
	public function rest_api_init() {
		\register_rest_route(
			...
			[
				...
				'args'                => [
					'id' => [
						'description' => \__( 'Mollie transaction ID.', 'pronamic-pay-with-mollie-for-woocommerce' ),
						'type'        => 'string',
						'required'    => true,
					],
				],
		...
		\register_rest_route(
			...
			[
				...
				'args'                => [
					'payment_id' => [
						'description' => \__( 'Payment ID.', 'pronamic-pay-with-mollie-for-woocommerce' ),
						'type'        => 'string',
						'required'    => true,
					],
					'id'         => [
		...
		\register_rest_route(
			...
			[
				...
				'args'                => [
					...
					'id'         => [
						'description' => \__( 'Mollie order ID.', 'pronamic-pay-with-mollie-for-woocommerce' ),
						'type'        => 'string',
						'required'    => true,
					],
				],
	...
	public function rest_api_mollie_webhook_payment( WP_REST_Request $request ) {
		...
		// Add note.
		$note = \__( 'Payment webhook requested by Mollie.', 'pronamic-pay-with-mollie-for-woocommerce' );
	...
	public function rest_api_mollie_webhook_order( WP_REST_Request $request ) {
		...
		// Add note.
		$note = \__( 'Order webhook requested by Mollie.', 'pronamic-pay-with-mollie-for-woocommerce' );
