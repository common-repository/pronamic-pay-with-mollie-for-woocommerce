...
class Integration extends AbstractGatewayIntegration {
	...
	public function __construct( $args = [] ) {
		$args = wp_parse_args(
			...
			[
				...
				'product_url'         => \__( 'https://www.mollie.com/en/pricing', 'pronamic-pay-with-mollie-for-woocommerce' ),
	...
	public function get_settings_fields() {
		...
		$fields[] = [
			...
			'title'    => _x( 'API Key', 'mollie', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'type'     => 'text',
			'classes'  => [ 'regular-text', 'code' ],
			'tooltip'  => __( 'API key as mentioned in the payment provider dashboard', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'required' => true,
		];
		...
		$fields[] = [
			...
			'title'       => _x( 'Due date days', 'mollie', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'type'        => 'number',
			'min'         => 1,
			'max'         => 100,
			'classes'     => [ 'regular-text' ],
			'tooltip'     => __( 'Number of days after which a bank transfer payment expires.', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'description' => sprintf(
				/* translators: 1: <code>1</code>, 2: <code>100</code>, 3: <code>12</code> */
				__( 'Minimum %1$s and maximum %2$s days. Default: %3$s days.', 'pronamic-pay-with-mollie-for-woocommerce' ),
		...
		$fields[] = [
			'section'  => 'feedback',
			'title'    => __( 'Webhook URL', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'type'     => 'text',
			'classes'  => [ 'large-text', 'code' ],
			'value'    => rest_url( self::REST_ROUTE_NAMESPACE . '/webhook' ),
			'readonly' => true,
			'tooltip'  => __( 'The Webhook URL as sent with each transaction to receive automatic payment status updates on.', 'pronamic-pay-with-mollie-for-woocommerce' ),
		];
