...
class Plugin {
	...
	public function add_countries_setting( $fields ) {
		$fields['pronamic_countries_title'] = [
			'title' => \__( 'Countries condition', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'type'  => 'title',
		];

		$fields['pronamic_countries'] = [
			'title'             => \__( 'Countries', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'type'              => 'multiselect',
			'class'             => 'wc-enhanced-select',
			'css'               => 'width: 400px;',
			'options'           => \WC()->countries->get_countries(),
			'default'           => '',
			'description'       => \__( 'If gateway is only available for certain countries, set it up here. Leave blank to enable for all countries.', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'desc_tip'          => true,
			'custom_attributes' => [
				'data-placeholder' => \__( 'Select some countries', 'pronamic-pay-with-mollie-for-woocommerce' ),
			],
		];
