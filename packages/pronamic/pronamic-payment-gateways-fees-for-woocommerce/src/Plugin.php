...
class Plugin {
	...
	public function add_fees_setting( $fields ) {
		$fields['pronamic_fees_title'] = [
			'title'       => \__( 'Fees', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'type'        => 'title',
			'description' => \sprintf(
				...
				\esc_url(
					\__( 'https://www.pronamicpay.com/en/manuals/can-i-charge-my-customers-for-payment-methods/', 'pronamic-pay-with-mollie-for-woocommerce' )
				)
			),
		];

		$fields['pronamic_fees_fixed_name'] = [
			'title'       => \__( 'Fixed fee name', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'type'        => 'text',
			'default'     => \__( 'Payment gateway fee', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'placeholder' => \__( 'Payment gateway fee', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'description' => \__( 'Fee name to show to customer. To display each fee on different lines in cart (and checkout), you must set different names. If names are equal they will be merged into single line.', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'desc_tip'    => true,
		];

		$fields['pronamic_fees_fixed_amount'] = [
			'title' => \__( 'Fixed amount', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'type'  => 'price',
		];

		$fields['pronamic_fees_percentage_name'] = [
			'title'       => \__( 'Variable fee name', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'type'        => 'text',
			'default'     => \__( 'Payment gateway fee', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'placeholder' => \__( 'Payment gateway fee', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'description' => \__( 'Fee name to show to customer. To display each fee on different lines in cart (and checkout), you must set different names. If names are equal they will be merged into single line.', 'pronamic-pay-with-mollie-for-woocommerce' ),
		...
		$fields['pronamic_fees_percentage_value'] = [
			'title'             => \__( 'Percentage value', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'type'              => 'number',
			'custom_attributes' => [
				'step' => 'any',
			],
		...
		$fields['pronamic_fees_tax_class'] = [
			'title'   => \__( 'Tax class', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'type'    => 'select',
			'options' => \wc_get_product_tax_class_options(),
		];

		$fields['pronamic_fees_no_fee_order_total_above'] = [
			'title'       => \__( 'No fee for order total above', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'type'        => 'price',
			'description' => \__( 'Enter the amount at which the fee will no longer be applied. If left blank, there will be no threshold.', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'desc_tip'    => true,
		];

		$fields['pronamic_fees_max_amount'] = [
			'title'       => \__( 'Maximum amount', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'type'        => 'price',
			'description' => \__( 'Enter the maximum fee amount. If left blank, there will be no maximum.', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'desc_tip'    => true,
		];
