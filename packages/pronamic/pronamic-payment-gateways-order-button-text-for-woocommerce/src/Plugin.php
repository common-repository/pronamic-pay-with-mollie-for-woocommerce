...
class Plugin {
	...
	public function add_order_button_text_setting( $fields ) {
		$fields['pronamic_order_button_text'] = [
			'title'       => \__( 'Order Button Text', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'type'        => 'text',
			'default'     => '',
			'description' => \__( 'This setting is added by the "Pronamic Payment Gateways Order Button Text for WooCommerce" plugin and affects what text visitors see on the WooCommerce order button, leave blank to use the default WooCommerce text.', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'desc_tip'    => true,
			'placeholder' => \__( 'Pay for order', 'pronamic-pay-with-mollie-for-woocommerce' ),
		];
