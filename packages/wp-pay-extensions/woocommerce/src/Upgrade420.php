		...
		foreach ( $woocommerce_subscriptions as $woocommerce_subscription ) {
			...
			$subscription->add_note(
				\sprintf(
					...
					__( 'Linked WooCommerce subscription with ID `%s` to this subscription during WooCommerce integration update (version 4.2.0).', 'pronamic-pay-with-mollie-for-woocommerce' ),
