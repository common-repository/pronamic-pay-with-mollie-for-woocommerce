...
class ActionScheduler_DataController {
	...
	public static function free_memory() {
		if ( 0 < self::$sleep_time ) {
			...
			\WP_CLI::warning( sprintf( _n( 'Stopped the insanity for %d second', 'Stopped the insanity for %d seconds', self::$sleep_time, 'pronamic-pay-with-mollie-for-woocommerce' ), self::$sleep_time ) );
			sleep( self::$sleep_time );
		}

		\WP_CLI::warning( __( 'Attempting to reduce used memory...', 'pronamic-pay-with-mollie-for-woocommerce' ) );
