...
class ActionScheduler_wpPostStore_PostStatusRegistrar {
	...
	protected function post_status_failed_labels() {
		$labels = array(
			'label'       => _x( 'Failed', 'post', 'pronamic-pay-with-mollie-for-woocommerce' ),
			/* translators: %s: count */
	...
	protected function post_status_running_labels() {
		$labels = array(
			'label'       => _x( 'In-Progress', 'post', 'pronamic-pay-with-mollie-for-woocommerce' ),
			/* translators: %s: count */
			'label_count' => _n_noop( 'In-Progress <span class="count">(%s)</span>', 'In-Progress <span class="count">(%s)</span>', 'pronamic-pay-with-mollie-for-woocommerce' ),
		);
