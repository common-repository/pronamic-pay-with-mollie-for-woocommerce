...
class ActionScheduler_wcSystemStatus {
	...
	protected function get_template( $status_labels, $action_counts, $oldest_and_newest ) {
		...
		<table class="wc_status_table widefat" cellspacing="0">
			<thead>
				<tr>
					<th colspan="5" data-export-label="Action Scheduler"><h2><?php esc_html_e( 'Action Scheduler', 'pronamic-pay-with-mollie-for-woocommerce' ); ?><?php echo wc_help_tip( esc_html__( 'This section shows details of Action Scheduler.', 'pronamic-pay-with-mollie-for-woocommerce' ) ); ?></h2></th>
				</tr>
				<tr>
					<td colspan="2" data-export-label="Version"><?php esc_html_e( 'Version:', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></td>
					<td colspan="3"><?php echo esc_html( $as_version ); ?></td>
				</tr>
				<tr>
					<td colspan="2" data-export-label="Data store"><?php esc_html_e( 'Data store:', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></td>
					<td colspan="3"><?php echo esc_html( $as_datastore ); ?></td>
				</tr>
				<tr>
					<td><strong><?php esc_html_e( 'Action Status', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></strong></td>
					<td class="help">&nbsp;</td>
					<td><strong><?php esc_html_e( 'Count', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></strong></td>
					<td><strong><?php esc_html_e( 'Oldest Scheduled Date', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></strong></td>
					<td><strong><?php esc_html_e( 'Newest Scheduled Date', 'pronamic-pay-with-mollie-for-woocommerce' ); ?></strong></td>
				</tr>
			</thead>
			<tbody>
				<?php
