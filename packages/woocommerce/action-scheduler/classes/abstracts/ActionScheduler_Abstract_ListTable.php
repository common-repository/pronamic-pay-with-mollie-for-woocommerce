...
abstract class ActionScheduler_Abstract_ListTable extends WP_List_Table {
	...
	public function extra_tablenav( $which ) {
		...
		submit_button( esc_html__( 'Filter', 'pronamic-pay-with-mollie-for-woocommerce' ), '', 'filter_action', false, array( 'id' => 'post-query-submit' ) );
		echo '</div>';
	}
	...
	protected function display_header() {
		...
		if ( $this->get_request_search_query() ) {
			...
			echo '<span class="subtitle">' . esc_attr( sprintf( __( 'Search results for "%s"', 'pronamic-pay-with-mollie-for-woocommerce' ), $this->get_request_search_query() ) ) . '</span>';
		}
	...
	protected function display_filter_by_status() {
		...
		$status_labels['all']      = esc_html_x( 'All', 'status labels', 'pronamic-pay-with-mollie-for-woocommerce' );
		$status_labels['past-due'] = esc_html_x( 'Past-due', 'status labels', 'pronamic-pay-with-mollie-for-woocommerce' );
	...
	protected function get_search_box_placeholder() {
		return esc_html__( 'Search', 'pronamic-pay-with-mollie-for-woocommerce' );
	}
