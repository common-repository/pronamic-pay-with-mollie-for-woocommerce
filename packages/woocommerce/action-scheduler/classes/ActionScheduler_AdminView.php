...
class ActionScheduler_AdminView extends ActionScheduler_AdminView_Deprecated {
	...
	public function register_system_status_tab( array $tabs ) {
		$tabs['action-scheduler'] = __( 'Scheduled Actions', 'pronamic-pay-with-mollie-for-woocommerce' );
	...
	public function register_menu() {
		$hook_suffix = add_submenu_page(
			'tools.php',
			__( 'Scheduled Actions', 'pronamic-pay-with-mollie-for-woocommerce' ),
			__( 'Scheduled Actions', 'pronamic-pay-with-mollie-for-woocommerce' ),
			'manage_options',
			'action-scheduler',
	...
	public function add_help_tabs() {
		...
		$screen->add_help_tab(
			array(
				...
				'title'   => __( 'About', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'content' =>
					// translators: %s is the Action Scheduler version.
					'<h2>' . sprintf( __( 'About Action Scheduler %s', 'pronamic-pay-with-mollie-for-woocommerce' ), $as_version ) . '</h2>' .
					'<p>' .
						__( 'Action Scheduler is a scalable, traceable job queue for background processing large sets of actions. Action Scheduler works by triggering an action hook to run at some time in the future. Scheduled actions can also be scheduled to run on a recurring schedule.', 'pronamic-pay-with-mollie-for-woocommerce' ) .
					'</p>',
			)
		);
		...
		$screen->add_help_tab(
			array(
				...
				'title'   => __( 'Columns', 'pronamic-pay-with-mollie-for-woocommerce' ),
				'content' =>
					'<h2>' . __( 'Scheduled Action Columns', 'pronamic-pay-with-mollie-for-woocommerce' ) . '</h2>' .
					'<ul>' .
					sprintf( '<li><strong>%1$s</strong>: %2$s</li>', __( 'Hook', 'pronamic-pay-with-mollie-for-woocommerce' ), __( 'Name of the action hook that will be triggered.', 'pronamic-pay-with-mollie-for-woocommerce' ) ) .
					sprintf( '<li><strong>%1$s</strong>: %2$s</li>', __( 'Status', 'pronamic-pay-with-mollie-for-woocommerce' ), __( 'Action statuses are Pending, Complete, Canceled, Failed', 'pronamic-pay-with-mollie-for-woocommerce' ) ) .
					sprintf( '<li><strong>%1$s</strong>: %2$s</li>', __( 'Arguments', 'pronamic-pay-with-mollie-for-woocommerce' ), __( 'Optional data array passed to the action hook.', 'pronamic-pay-with-mollie-for-woocommerce' ) ) .
					sprintf( '<li><strong>%1$s</strong>: %2$s</li>', __( 'Group', 'pronamic-pay-with-mollie-for-woocommerce' ), __( 'Optional action group.', 'pronamic-pay-with-mollie-for-woocommerce' ) ) .
					sprintf( '<li><strong>%1$s</strong>: %2$s</li>', __( 'Recurrence', 'pronamic-pay-with-mollie-for-woocommerce' ), __( 'The action\'s schedule frequency.', 'pronamic-pay-with-mollie-for-woocommerce' ) ) .
					sprintf( '<li><strong>%1$s</strong>: %2$s</li>', __( 'Scheduled', 'pronamic-pay-with-mollie-for-woocommerce' ), __( 'The date/time the action is/was scheduled to run.', 'pronamic-pay-with-mollie-for-woocommerce' ) ) .
					sprintf( '<li><strong>%1$s</strong>: %2$s</li>', __( 'Log', 'pronamic-pay-with-mollie-for-woocommerce' ), __( 'Activity log for the action.', 'pronamic-pay-with-mollie-for-woocommerce' ) ) .
					'</ul>',
			)
		);
	}
